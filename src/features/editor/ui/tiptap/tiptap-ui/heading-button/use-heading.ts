...
// --- Icons ---
import { HeadingOneIcon } from '@/features/editor/ui/tiptap/tiptap-icons/heading-one-icon'
import { HeadingTwoIcon } from '@/features/editor/ui/tiptap/tiptap-icons/heading-two-icon'
import { HeadingThreeIcon } from '@/features/editor/ui/tiptap/tiptap-icons/heading-three-icon'
import { HeadingFourIcon } from '@/features/editor/ui/tiptap/tiptap-icons/heading-four-icon'
import { HeadingFiveIcon } from '@/features/editor/ui/tiptap/tiptap-icons/heading-five-icon'
import { HeadingSixIcon } from '@/features/editor/ui/tiptap/tiptap-icons/heading-six-icon'
...
export function useHeading(config: UseHeadingConfig) {
	...
	React.useEffect(() => {
		...
		const handleSelectionUpdate = () => {
			setIsVisible(
				shouldShowButton({ editor, level, hideWhenUnavailable }),
			)
		}
