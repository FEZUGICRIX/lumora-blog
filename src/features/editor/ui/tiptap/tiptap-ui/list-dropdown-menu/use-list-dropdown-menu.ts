...
// --- Icons ---
import { ListIcon } from '@/features/editor/ui/tiptap/tiptap-icons/list-icon'
import { ListOrderedIcon } from '@/features/editor/ui/tiptap/tiptap-icons/list-ordered-icon'
import { ListTodoIcon } from '@/features/editor/ui/tiptap/tiptap-icons/list-todo-icon'

// --- Lib ---
import { isNodeInSchema } from '@/shared/lib/shadcn/utils/tiptap-utils'
...
import {
	...
	listIcons,
	type ListType,
} from '@/features/editor/ui/tiptap/tiptap-ui/list-button'
...
export function shouldShowListDropdown(params: {
	...
	const { editor, hideWhenUnavailable, listInSchema, canToggleAny } =
		params
...
export function useListDropdownMenu(config?: UseListDropdownMenuConfig) {
	...
	const activeList = filteredLists.find(
