...
export type GetArticlesQuery = { __typename?: 'Query', getArticles: Array<{ __typename?: 'Article', id: string, title: string, slug: string, description: string, contentJson: any, contentHtml: string, contentText: string, tags: Array<string>, coverImage?: string | null, published: boolean, publishedAt?: Date | null, readingTime: number, views: number, likes: number, commentsCount?: number | null, createdAt: Date, updatedAt: Date, author: { __typename?: 'UserPublicProfile', id: string, displayName: string, username: string, avatarUrl?: string | null }, category: { __typename?: 'Category', id: string, name: string, slug: string }, comments: Array<{ __typename?: 'Comment', id: string, content: string, createdAt: Date, updatedAt: Date, author: { __typename?: 'UserPublicProfile', id: string, username: string, displayName: string, avatarUrl?: string | null } }> }> };
...
export type RemoveCommentMutation = { __typename?: 'Mutation', removeComment: { __typename?: 'Comment', id: string, content: string } };
